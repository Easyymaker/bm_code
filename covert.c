...
#define SAMPLES 150 // TODO: CONFIGURE THIS - change to improve time
...
int main()
{
    ...
    char* secret="please,read this letter very attentively.today,as I have already noticed we have a lot of work to do: 1) receive your material. 2) make our first payment to you.  as you understand everything is prearranged and done with the utmost security.  the only thing for you to do is to act as quickly and accurately as possible.  so, please, strictly follow the instruction below and it will be as easy as a, b, c.after reading this letter, scrutinizing map, pictures and sketches (enclosed.  your routes are shown in green and places of operations in red.)  proceed garden state pkwy (northbound).take exiPark your car as shown in picture#1 and go to the EASTBOUND PLATFORM of the station.  At the east end of the platform there is a wooden stair.  Descending this stair drop your pack (with material) on the ground near the wooden pole of the stair.  (See picture #2.)  After that go to your car and immediately leave this area.  Your material will be picked up by us just in seconds.Again take Garden Satt";
    char result[200];
